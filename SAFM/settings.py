...
def parse_args():
    ...
    tokenizer = tokenizer_class.from_pretrained('/home/xic/.cache/huggingface/hub/gpt2')
    ...
    model_config = config_class.from_pretrained('/home/xic/.cache/huggingface/hub/gpt2')
