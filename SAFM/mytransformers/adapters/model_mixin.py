...
class ModelAdaptersMixin(ABC):
    ...
    def set_active_adapters(
        ...
        print("adapter_setup[line179]:", adapter_setup)
...
class ModelWithHeadsAdaptersMixin(ModelAdaptersMixin):
    ...
    def add_adapter(self, adapter_name: str, config=None, typ='MLP'):
        """
        Adds a new adapter module of the specified type to the model.
        ...
        Args:
            ...
            config (str or dict, optional): The adapter configuration, can be either:
                ...
                - if not given, the default configuration for this adapter type will be used
        """
        self.base_model.add_adapter(adapter_name, config, typ)

    def setup_task_adapter(self, tid, unshared_adapter_layer_list=[]):
        return self.base_model.setup_task_adapter(tid, unshared_adapter_layer_list=unshared_adapter_layer_list)
